...
typedef NS_OPTIONS(NSInteger, SegmentViewComponent) {
    ...
    SegmentViewComponentShowLeftExtraButton = 1 << 10,
...
/** 是否显示左侧附加按钮 默认为NO*/
@property (assign, nonatomic, getter=isShowLeftExtraButton) BOOL showLeftExtraButton;
...
/** 设置左侧附加按钮的背景图片, 默认为nil */
@property (strong, nonatomic) NSString *leftExtraBtnBackgroundImageName;
/** 滚动条的高度 默认为2 */
