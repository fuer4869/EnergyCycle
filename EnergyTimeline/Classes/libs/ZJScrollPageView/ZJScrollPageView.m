...
- (void)setLeftExtraBtnOnClick:(LeftExtraBtnOnClick)leftExtraBtnOnClick {
    _leftExtraBtnOnClick = leftExtraBtnOnClick;
    self.segmentView.leftExtraBtnOnClick = leftExtraBtnOnClick;
}
