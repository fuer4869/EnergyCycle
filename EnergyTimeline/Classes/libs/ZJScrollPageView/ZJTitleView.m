...
- (void)setNormalImage:(UIImage *)normalImage {
    ...
    if (!_imageSizeLimit) {
        ...
        _imageWidth = self.imageViewSize.width;
        _imageHeight = self.imageViewSize.height;
    }
...
- (void)setImageViewConentMode:(UIViewContentMode)imageViewConentMode {
    _imageViewConentMode = imageViewConentMode;
    self.imageView.contentMode = imageViewConentMode;
}

- (void)setImageViewSize:(CGSize)imageViewSize {
    _imageViewSize = imageViewSize;
    _imageWidth = imageViewSize.width;
    _imageHeight = imageViewSize.height;
    _imageSizeLimit = YES;
}
