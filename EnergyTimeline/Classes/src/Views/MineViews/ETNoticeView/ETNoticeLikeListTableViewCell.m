//
//  ETNoticeLikeListTableViewCell.m
//  能量圈
//
...
@interface ETNoticeLikeListTableViewCell ()
...
@implementation ETNoticeLikeListTableViewCell
...
- (void)setViewModel:(ETNoticeLikeListTableViewCellViewModel *)viewModel {
    if (!viewModel.model) {
        return;
    }
