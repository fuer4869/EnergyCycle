...
#import "ETNoticeLikeListTableViewCell.h"
#import "ETNoDataTableViewCell.h"

#import "ETRefreshGifHeader.h"

@interface ETNoticeLikeListView () <UITableViewDelegate, UITableViewDataSource>
...
@implementation ETNoticeLikeListView
...
- (instancetype)initWithViewModel:(id<ETViewModelProtocol>)viewModel {
    self.viewModel = (ETNoticeLikeListViewModel *)viewModel;
...
- (UITableView *)mainTableView {
    if (!_mainTableView) {
        ...
        [_mainTableView registerNib:NibName(ETNoticeLikeListTableViewCell) forCellReuseIdentifier:ClassName(ETNoticeLikeListTableViewCell)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (self.viewModel.dataArray.count) {
        ETNoticeLikeListTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:ClassName(ETNoticeLikeListTableViewCell) forIndexPath:indexPath];
