...
@interface ETHomePageLogVC ()

@property (nonatomic, strong) ETHomePageLogView *mainView;

@property (nonatomic, strong) ETHomePageViewModel *viewModel;

@end

@implementation ETHomePageLogVC
...
- (ETHomePageLogView *)mainView {
    if (!_mainView) {
        _mainView = [[ETHomePageLogView alloc] initWithViewModel:self.viewModel];
    }
    return _mainView;
}
