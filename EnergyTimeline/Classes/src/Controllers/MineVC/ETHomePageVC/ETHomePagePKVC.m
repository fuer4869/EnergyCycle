...
@interface ETHomePagePKVC ()

@property (nonatomic, strong) ETHomePagePKView *mainView;

@property (nonatomic, strong) ETHomePageViewModel *viewModel;

@end

@implementation ETHomePagePKVC
...
- (ETHomePagePKView *)mainView {
    if (!_mainView) {
        _mainView = [[ETHomePagePKView alloc] initWithViewModel:self.viewModel];
    }
    return _mainView;
}
