...
@interface ETHomePagePKRecordVC ()

@property (nonatomic, strong) ETHomePagePKRecordView *mainView;

@property (nonatomic, strong) ETHomePageViewModel *viewModel;

@end

@implementation ETHomePagePKRecordVC
...
- (ETHomePagePKRecordView *)mainView {
    if (!_mainView) {
        _mainView = [[ETHomePagePKRecordView alloc] initWithViewModel:self.viewModel];
    }
    return _mainView;
}
